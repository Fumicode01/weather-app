  ...
  return (
        <div className="flex">
            {forecastWeathers?.map((weather) => (
                <div key={weather.date} className="w-48 cursor-pointer border b-gray-400 rounded-3xl flex flex-col justify-center items-center text-center p-6 bg-slate-100">
